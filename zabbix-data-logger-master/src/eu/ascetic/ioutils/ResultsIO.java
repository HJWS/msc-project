...
import eu.ascetic.publish.Publish;
...
public class ResultsIO {
    ...
    public static void writeResults(ArrayList<ArrayList<String>> results,
        ...
        try {
            ...
            try(BufferedWriter bufferedWriter = new BufferedWriter(fileWriter))  {   //BufferedWriter bufferedWriter = new BufferedWriter(fileWriter)
                Publish publish = new Publish("cscloud1n2");
                String element;
                for (int k = 0; k < results.size(); k++) {
                    ...
                    for (int i = 0; i < currentRow.size(); i++) {
                        ...
                        if (i != currentRow.size() - 1) {
                            publish.publishMessage("loadcscloud1n2", element + delimeter, 1);
                            bufferedWriter.write(element + delimeter);
                            System.out.println(element + delimeter);
                        } else {
                            /**
                            ...
                            if (k != results.size() - 1 || append) {
                                ...
                                publish.publishMessage("loadcscloud1n2", element + NEW_LINE, 1);
                                bufferedWriter.write(element + NEW_LINE);
                                System.out.println(element + NEW_LINE);
                            } else {
                                publish.publishMessage("loadcscloud1n2", element, 1);
