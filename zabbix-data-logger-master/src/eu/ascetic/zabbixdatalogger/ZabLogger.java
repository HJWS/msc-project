    ...
    public static void main(String[] args) throws IOException {
        ...
        while (running) {
            if (host != null) {
                ...
                running = false;
                java.util.logging.Logger.getLogger(ZabLogger.class.getName()).log(Level.INFO, "The resource named was not found");
            }
            try {
                Thread.sleep(1000);
            } catch (InterruptedException ex) {
                java.util.logging.Logger.getLogger(ZabLogger.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        logger.stop();
    }
